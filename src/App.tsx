                ...
                {showPaywall && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 bg-black/95 backdrop-blur-xl z-50 flex items-center justify-center p-8">
                        <div className="max-w-sm text-center">
                            ...
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-relaxed mb-8">You've reached your free limit. To unlock unlimited global calculations and audit-ready PDF exports, upgrade to Pro ($49 USD) or buy a Single Report ($5 USD).</p>
